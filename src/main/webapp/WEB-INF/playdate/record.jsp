...
<%--<script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script> &lt;%&ndash;without this polyfill, the map won't load.&ndash;%&gt;--%>
<%--<script src="https://unpkg.com/axios@1.1.2/dist/axios.min.js"></script> &lt;%&ndash; this enables the geocode that's embedded in initMap function&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                <div class="card p-2 border-0">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <p class="m-0 text-secondary" style="font-size: 0.8rem;">Comment</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <pre style="white-space: pre-wrap" class="m-0">${playdate.comment}</pre>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--            </c:when>--%>
...
<%--&lt;%&ndash;                <div class="card p-2 border-0">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <p class="m-0 text-secondary" style="font-size: 0.8rem;">Comment</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <pre style="white-space: pre-wrap" class="m-0">${rsvpObjForAuthUser.comment}</pre>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
...
<%--            </c:when>--%>
<%--            <c:otherwise>--%>
<%--&lt;%&ndash;                <div class="card p-2 border-0 d-md-flex justify-content-center bg-light mb-2">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <p class="m-0 text-center text-secondary">You have not yet RSVPed for this event.</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
...
<%--                    <div class = "container m-0 p-0">--%>
<%--&lt;%&ndash;                        <div class="d-flex flex-row justify-content-evenly flex-wrap m-0 p-0">&ndash;%&gt;--%>
<%--                        <div class="row m-0 p-0">--%>
<%--                            <div class="form-floating col-sm me-5 p-0 ">--%>
<%--                                <form:select--%>
<%--                                        path="rsvpStatus"--%>
...
<%--&lt;%&ndash;                        <form:textarea&ndash;%&gt;--%>
<%--&lt;%&ndash;                                path="comment"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                type="text"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                class="form-control"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                id="comment"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                placeholder="comment"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                style="height: 5rem;" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <form:label path="comment" for="comment">Comment</form:label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <p class="text-danger"><form:errors path="comment" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
